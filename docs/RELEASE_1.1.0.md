...
Status: the corrected release images are published to `glassbox-bio-public`. The direct deployer passed the official Marketplace verifier and its exact production digest was independently verified on 2026-08-26. Marketplace Full Preview and the customer-billed scientific workload remain release gates.
...
| Direct deployer | `us-docker.pkg.dev/glassbox-bio-public/glassbox-bio-molecular-ip-fto-screening/deployer:1.1.0` | `sha256:277c17246aa43591a0dc5cfb375ab7cdbf72be1234945c47d01ff5e67c05dc48` |
